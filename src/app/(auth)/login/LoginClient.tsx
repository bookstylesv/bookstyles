  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', minHeight: '100vh', background: theme.rightBase, position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: '-8px', zIndex: 0, pointerEvents: 'none', backgroundImage: `url("${theme.rightImage}")`, backgroundSize: 'cover', backgroundPosition: isSalon ? 'center' : 'center top', filter: isSalon ? 'blur(0.4px) brightness(0.46) saturate(0.96)' : 'blur(0.5px) brightness(0.42) saturate(0.85)' }} />
