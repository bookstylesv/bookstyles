...
const SECTORS: Record<LoginTheme, {
  ...
  'barberia-carbon-white': {
    sectorLabel: 'Barberia', eyebrow: 'Premium barber', helperEmpresa: 'Ingresa el codigo de tu barberia', helperAcceso: 'Accede a tu cuenta', headerName: 'Speeddan Barberia', companyLabel: 'Codigo de empresa', companyPlaceholder: 'ej: mi-barberia', footerNote: 'Speeddan ERP · Sistema seguro', heroFooter: 'ERP Multi-tenant para barberias', tagline: 'Estilo minimal en blanco y negro', accentA: '#374151', accentB: '#f1f5f9', glow: 'rgba(241,245,249,0.22)', focus: 'rgba(241,245,249,0.55)', text: '#f9fafb', muted: 'rgba(249,250,251,0.58)', labelColor: 'rgba(249,250,251,0.56)', card: 'rgba(255,255,255,0.055)', cardBorder: 'rgba(255,255,255,0.14)', input: 'rgba(255,255,255,0.07)', inputBorder: 'rgba(255,255,255,0.18)', leftBase: 'hsl(220 14% 5%)', rightBase: 'hsl(220 14% 3%)', leftImage: 'https://images.unsplash.com/photo-1599351431202-1e0f0137899a?auto=format&fit=crop&w=1400&q=80', rightImage: 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&w=1400&q=80', leftOverlay: 'linear-gradient(145deg, rgba(5,5,10,0.60) 0%, rgba(15,15,25,0.52) 50%, rgba(30,30,45,0.36) 100%)', rightOverlay: 'linear-gradient(160deg, rgba(4,4,8,0.88) 0%, rgba(10,10,18,0.82) 52%, rgba(18,18,30,0.86) 100%)', leftOrb: 'radial-gradient(circle, rgba(241,245,249,0.12) 0%, transparent 70%)', rightOrb: 'radial-gradient(circle, rgba(241,245,249,0.08) 0%, transparent 70%)', chipBg: 'rgba(241,245,249,0.14)', chipBorder: 'rgba(241,245,249,0.26)', chipText: '#f1f5f9', stepDone: '#f1f5f9', stepIdle: 'rgba(255,255,255,0.10)', useDisplay: false, features: [{ title: 'Estilo B&W', description: 'Agenda y turnos modernos' }, { title: 'Control de Caja', description: 'Reportes en tiempo real' }, { title: 'Clientes VIP', description: 'Historial y preferencias' }],
  },
